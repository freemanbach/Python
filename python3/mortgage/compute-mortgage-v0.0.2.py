...
example : python3 compute-mortgage-v0.0.2.py -h
example : python3 compute-mortgage-v0.0.2.py -v
"""
    ...
    for i in range(1, mon+1):
        ...
        for x in range(1, daysInMonth+1):
            ...
            if mvalue == "03" and str(dvalue) == "31":
                print()
            if mvalue == "04" and str(dvalue) == "30":
                print()
            if mvalue == "05" and str(dvalue) == "31":
                print()
            if mvalue == "06" and str(dvalue) == "30":
                print()
            if mvalue == "07" and str(dvalue) == "31":
                print()
            if mvalue == "08" and str(dvalue) == "31":
                print()
            if mvalue == "09" and str(dvalue) == "30":
                print()
            if mvalue == "10" and str(dvalue) == "31":
                print()
            if mvalue == "11" and str(dvalue) == "30":
                print()
            if mvalue == "12" and str(dvalue) == "31":
                print()
        ...
        if tot < 0:
            print("The Loan Amount owed to bank has been paid.")
            sys.exit(0)
        else:
            continue
