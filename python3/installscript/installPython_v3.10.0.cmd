...
C:\Python310\Scripts\pip.exe install --user requests tqdm diceware scipy numpy pandas matplotlib seaborn wikipedia pillow pandas_datareader yfinance plotly
timeout /T 4 > nul
