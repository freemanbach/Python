...
:check_Permissions
    ...
    if %errorLevel% == 0 (
        ...
        echo run this script to install Python v3.10.4 Silently.
        echo Exiting....
        goto end
    )
::    pause >nul
...
set Value="n"
:PROMPT
SET /P Value=Are you sure installing Python-3.10.4 (y/[n])?
IF /I "%Value%" NEQ "y" GOTO END

:: This batch file will show details Windows 10, and install Python v3.10.4
...
echo.
echo.
C:\Windows\SysWOW64\bitsadmin.exe /transfer PythonDownload /download /priority normal https://www.python.org/ftp/python/3.10.4/python-3.10.4-amd64.exe C:\Users\%USERNAME%\Downloads\python-3.10.4-amd64.exe
::
echo.
echo.
timeout /T 2 > nul
...
echo.============================
echo.
echo.Installing Python version 3.10.4
...
C:\Python3104\python.exe -m pip install --upgrade pip
::
:: Quick Pause
timeout /T 2 > nul
echo.
...
:: Quick Pause
timeout /T 1 > nul
C:\Python3104\Scripts\pip.exe install --user wheel
timeout /T 1 > nul
echo done
::
echo.
...
echo.============================
::
echo set PATH=C:\Python3104;%PATH% > C:\Users\%USERNAME%\runme.bat
del /s C:\Users\%USERNAME%\Downloads\python-3.10.4-amd64.exe >nul 2>&1
