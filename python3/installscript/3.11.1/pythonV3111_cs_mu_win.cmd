...
REM 32bit path    : https://www.python.org/ftp/python/3.11.1/python-3.11.1.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.1/python-3.11.1-amd64.exe
REM Date          : 2022.12.07
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.1 x86-64 or x86 (y/[n]) ?
    if /i "%_value%" NEQ "y" goto end

:: This batch file will show details Windows 10, and install Python v3.11.1
:section_0
    setlocal
