...
echo.
echo.
C:\Windows\SysWOW64\bitsadmin.exe /transfer PythonDownload /download /priority normal https://www.python.org/ftp/python/3.9.8/python-3.9.8-amd64.exe %userprofile%\Downloads\python-3.9.8-amd64.exe
::
echo.
echo.
timeout /T 1 > nul
...
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user pandas_datareader ta scipy numpy plotly
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user pandas matplotlib seaborn statsmodels QuantLib pyfinlab
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user PyAlgoTrade Statistics-pyt backtrader
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user arrow prettypandas beautifier tabulate
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user keras BeautifulSoup4 scrapy
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user nltk pybrain
timeout /T 1 > nul
C:\Python398\Scripts\pip.exe install --user scikit-learn
timeout /T 1 > nul
...
echo.============================
::
echo set PATH=C:\Python398;%PATH% > %userprofile%\runme.bat
del /s %userprofile%\Downloads\python-3.9.8-amd64.exe >nul 2>&1
