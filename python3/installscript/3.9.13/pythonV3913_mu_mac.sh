...
curl -C - -O https://www.python.org/ftp/python/3.9.13/python-3.9.13-macos11.pkg 
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.9.13-macos11.pkg -target /Applications
###############################
...
/Library/Frameworks/Python.framework/Versions/3.9/bin/python3 -m pip install --user wikipedia wordcloud
#
##############################
