...
echo.
echo.
bitsadmin /transfer PythonDownload /download /priority normal https://www.python.org/ftp/python/3.8.9/python-3.8.9-amd64.exe %userprofile%\Downloads\python-3.8.9-amd64.exe
...
IF EXIST python-3.8.9-amd64.exe (
...
echo.
echo.Installing Python version 3.8.9.
...
del /s %userprofile%\Downloads\python-3.8.9-amd64.exe >nul 2>&1
