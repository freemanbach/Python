...
REM 32bit path    : https://www.python.org/ftp/python/3.10.6/python-3.10.6.exe
REM 64bit path    : https://www.python.org/ftp/python/3.10.6/python-3.10.6-amd64.exe
REM Date          : 2022.08.13
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.10.6-amd64 (y/[n]) ?
    if /i "%_value%" NEQ "y" goto end

:: This batch file will show details Windows 10, and install Python v3.10.6
:section_0
    setlocal
