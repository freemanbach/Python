...
:section_13
    ...
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user pandas_datareader ta scipy numpy plotly
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user pandas matplotlib seaborn 
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user statsmodels QuantLib pyfinlab
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user PyAlgoTrade Statistics-pyt backtrader
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user arrow prettypandas beautifier tabulate
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user keras BeautifulSoup4 scrapy
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user scikit-learn nltk pybrain
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user pydot pygal alpha-vantage
    timeout /T 1 > nul
    C:\Python3912\Scripts\pip.exe install --user yfinance wikipedia wordcloud
    timeout /T 4 > nul
    echo. 85%% Completed.
    echo.
