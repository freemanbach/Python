...
REM 32bit path    : https://www.python.org/ftp/python/3.10.5/python-3.10.5.exe
REM 64bit path    : https://www.python.org/ftp/python/3.10.5/python-3.10.5-amd64.exe
REM Date          : 2022.07.04
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.10.5 (y/[n]) ?
    if /i "%_value%" NEQ "y" goto end

:: This batch file will show details Windows 10, and install Python v3.10.5
:section_0
    setlocal
